...
DAGS_v1.0_Canonical File List
README_DAGS_v1.0
Folder Roles
00_Governance/
Normative editorial governance, scope boundaries, terminology, language rules, and versioning controls applicable to this standard.
01_Standard_Overview/
...
05_Cross-Cutting_Requirements/
Normative requirements that apply across domains (documentation, ownership, auditability/traceability).
06_Prohibitions_and_Constraints/
Normative prohibitions, non-substitution rules, and misuse constraints.
07_Appendices_(Normative)/
Normative appendices (definitions, mapping rules, legal/licensing notices, normative references).
DAGS_v1.0_Canonical File List
Canonical inventory of required files for completeness and integrity checking.
README_DAGS_v1.0
Repository guide and authority boundaries for this DAGS v1.0 package.
