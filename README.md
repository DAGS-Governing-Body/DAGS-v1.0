# DAGS-v1.0
A normative, implementation-neutral standard defining deployment-layer governance validity conditions for AI systems, including accountability, authority attribution, and independently verifiable evidence generation.
...
Nothing outside DAGS_v1.0/ modifies, interprets, weakens, or substitutes for those requirements.
...
- DAGS-STD-040_Regulatory_Crosswalk
- README_DAGS_v1.0
- Release_Notes_DAGS_v1.0
...
- **08_Operational_Guidance_(Non-Normative)** – Non-normative guidance and supporting materials. 

**Non-normative supporting artifacts**
- **Release_Notes_DAGS_v1.0** – Documents version history, substantive changes, and publication status for each official release of the DAGS standard.
- **DAGS-STD-040_Regulatory_Crosswalk** – Maps DAGS controls to major regulatory and standards frameworks to support alignment and traceability.
...
- **08_Operational_Guidance_(Non-Normative)** (non-normative guidance)
...
- The entirety of the DAGS v1.0 package, as contained within the DAGS_v1.0 directory, is normative and controlling.
